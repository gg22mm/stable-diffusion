...
opt.base=['configs/latent-diffusion/layout2img/coco_sg2im_ldm_Layout2I_vqgan_f8.yaml']
opt.finetune=''
opt.scale_lr=True
...
# model
# model = getattr( importlib.import_module('ldm.models.diffusion.ddpm', package=None) , 'Layout2ImgDiffusion' )( **config.model.get("params", dict()) ) #也可以写死这样 

from ldm.models.diffusion.ddpm import  Layout2ImgDiffusion
model = Layout2ImgDiffusion( **config.model.get("params", dict()) ) #也可以写死这样    
